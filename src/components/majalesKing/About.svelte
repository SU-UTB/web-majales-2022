<section id="about-king" class="relative pb-12 -top-40">
  <div class="mt-24">
    <div class="w-full md:w-4/5 mx-auto px-8 md:px-4 flex items-center justify-center lg:justify-between flex-wrap">
      ...
      <div class="about-desc w-full lg:w-2/3 2xl:w-1/2 lg:mt-4">
        <p class="mb-2 mt-6"><span class="txt-bold">Soutěž probíhá ve smíšených párech,</span> muž i žena musí být ze stejné fakulty. Pokud nemáš parťáka, tak nezoufej — nějakého ti dohodíme.</p>
